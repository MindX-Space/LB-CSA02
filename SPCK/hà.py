"""
    Phân tích mối quan hệ giữa thời gian tự học hàng tuần của học sinh 
    và điểm trung bình của họ trong các môn học chính (Toán, Vật lý, Tiếng Anh, và Lịch sử)
    Sử dụng biểu đồ: Bars
"""
